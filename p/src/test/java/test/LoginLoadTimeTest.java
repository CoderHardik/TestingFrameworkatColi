...
public class LoginLoadTimeTest {
	WebDriver driver;
    LoginPage objLogin;
...
@BeforeMethod 
  public void beforeMethod() throws IOException {
	  ...
	  //FileInputStream fis = new FileInputStream("/Users/hshah/git/GUIandAPItestColi/p/src/test/java/test/data.properties");
	  prop.load(fis);
...
@Test(priority=0)
	public void test_whats_happening_activities() throws InterruptedException{
		...
		wait.until(string->objHomePage.getwhats_happening_carousel_current_visible().getAttribute("class").contains("slide1"));
...
@Test(priority=0)
	...
	//This case still has timing issues. Need to make sure to fix the carousel to get right value
		...
		wait.until(string->!objHomePage.getWhats_happening_carousel_text_risk().contains("0"));
		wait.until(ExpectedConditions.visibilityOf(objHomePage.getwhats_happening_carousel_current_visible()));
		wait.until(string->objHomePage.getwhats_happening_carousel_current_visible().getAttribute("class").contains("slide2"));
...
@Test(priority=0)
	public void test_whats_happening_play() throws InterruptedException{
		...
		wait.until(string->!objHomePage.getWhats_happening_carousel_play_text_count().contains("0"));
		wait.until(ExpectedConditions.visibilityOf(objHomePage.getwhats_happening_carousel_current_visible()));
		wait.until(string->objHomePage.getwhats_happening_carousel_current_visible().getAttribute("class").contains("slide3"));
...
@Test(priority=0)
	public void test_top_deals_most_activity_present() throws InterruptedException{
		WebDriverWait wait = new WebDriverWait(driver,30);
		
		wait.until(ExpectedConditions.invisibilityOf(objHomePage.getTopDealSpinner()));
		
		Assert.assertEquals(objHomePage.getTopDealMostActivityLabel().isDisplayed(),true);
}//end of test

@Test(priority=0)
	public void test_top_deals_closing_soon_present() throws InterruptedException{
		WebDriverWait wait = new WebDriverWait(driver,30);
	
		wait.until(ExpectedConditions.invisibilityOf(objHomePage.getTopDealSpinner()));
		
		Assert.assertEquals(objHomePage.getTopDealClosingSoonLabel().isDisplayed(),true);
}//end of test


@Test(priority=0)
public void test_top_deals_highest_revenue_present() throws InterruptedException{
	WebDriverWait wait = new WebDriverWait(driver,30);
